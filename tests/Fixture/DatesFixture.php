...
class DatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'month' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'year' => ['type' => 'index', 'columns' => ['year', 'month', 'week'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'year' => 1,
                'created' => '2021-02-11 08:37:41',
                'modified' => '2021-02-11 08:37:41',
            ],
        ];
        parent::init();
    }
